...
-- REFACTORIZADO: Principios de Normalización 1FN y 2FN Aplicados
-- ============================================================================
...
-- ----------------------------------------------------------------------------
-- 1. TABLA: roles (Perfiles de Acceso al Sistema y Redirección 2FN)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 2. TABLA: usuarios (Nómina de Empleados y Autenticación por PIN - 2FN Aplicada)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 6. TABLA: ordenes_compra (Encabezado de Órdenes de Compra - 1FN Aplicada)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 7b. TABLA: ventas_detalle (Única Tabla Canónica de Renglones Vendidos)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 9b. TABLA: asientos_detalle (Renglones de Partida Doble Debe / Haber)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 11. TABLA: configuracion_empresa (Datos Fiscales de la Empresa - Limpieza 2FN)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 12. TABLA: lotes_produccion (Lotes Leudados Listos para Horneado - Staging)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 13. TABLA: estado_hornos (Única Tabla Canónica de Monitoreo de Hornos Industriales)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 14. TABLA: comandas_cocina (Comandas POS KDS Módulo 2)
-- ----------------------------------------------------------------------------
...
-- ============================================================================
-- INSERCIÓN DE DATOS DE SEMILLA (SEED DATA INICIAL ACTUALIZADO)
-- ============================================================================

-- 1. Datos Fiscales de la Empresa (Sin columnas de tasa)
...
-- 2. Configuraciones Iniciales de Tasa BCV y Modo Login
...
-- 3. Roles del Sistema (Incluyendo redirect_url extraído de usuarios)
...
-- 11. Lotes de Producción y Estado de Hornos (Única Tabla Canónica)
